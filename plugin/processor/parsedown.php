<?php
// slightly modified for MoniWiki by wkpark@gmail.com
/**
 * @author              (c) Emanuil Rusev
 * @package             Parsedown
 * @date                9 January, 2004
 * @version             $Revision: 1.0 $
 * @depend              1.1.3
 * @description         Markdown processor for MoniWiki
 */
...
class processor_parsedown
{
    ...
    function parse_block_elements($lines, $context = '')
    {
        $blocks = array();
